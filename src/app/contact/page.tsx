              ...
              <div className="space-y-10">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@startovatetech.com" className="text-2xl font-josefin font-bold hover:text-primary transition-colors underline decoration-primary/20">info@startovatetech.com</a>
                  </div>
                </div>
